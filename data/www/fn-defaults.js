...
const BASIC_FUNCTIONS = [
  ...
  fn(3,  'Dynamic Brake', true,  CP.compress,             CP.compress,               RED),
  ...
  fn(7,  'Coupler',       false, CP['screwdriver-wrench'],CP['screwdriver-wrench'],  CYAN),
...
const EXTENDED_FUNCTIONS = [
  ...
  fn(11, 'Air Compressor',true,  CP.compress,             CP['wind-turbine'],        CYAN),
  fn(12, 'Brake Squeal',  false, CP['tire-pressure-warning'], CP['tire-pressure-warning'], RED),
